      ...
      <div class="flex flex-col gap-4 p-5">
        ...
        <div class="mt-2 flex flex-wrap items-center gap-5">
          <a href={project.repo} target="_blank" aria-label="GitHub Repo">
            <svg class="h-6 w-6 transition-transform duration-200 hover:-translate-y-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
              <path
          ...
          <a href={project.liveDemo} target="_blank" aria-label="Live Website">
            <svg class="h-6 w-6 transition-transform duration-200 hover:-translate-y-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              <path
